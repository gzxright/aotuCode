...
/****
 * @Author:shenkunlin
 * @Description:AuthRefreshToken构建
 * @Date 2019/6/14 19:13
 *****/
@ApiModel(description = "AuthRefreshToken",value = "AuthRefreshToken")
...
public class AuthRefreshToken implements Serializable{
	...
	@ApiModelProperty(value = "表auth_access_token对应的Access Token记录",required = false)
    @Column(name = "token_id")
	private Integer tokenId;//表auth_access_token对应的Access Token记录
