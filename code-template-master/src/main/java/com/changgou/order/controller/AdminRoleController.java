...
public class AdminRoleController {
    ...
    @ApiImplicitParam(paramType = "path", name = "id", value = "主键ID", required = true, dataType = "")
    @PutMapping(value="/{id}")
    public Result update(@RequestBody @ApiParam(name = "AdminRole对象",value = "传入JSON数据",required = false) AdminRole adminRole,@PathVariable  id){
        //设置主键值
        adminRole.set(id);
    ...
    @ApiImplicitParam(paramType = "path", name = "id", value = "主键ID", required = true, dataType = "")
    @GetMapping("/{id}")
    public Result<AdminRole> findById(@PathVariable  id){
