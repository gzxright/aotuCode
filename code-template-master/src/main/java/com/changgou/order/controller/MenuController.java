...
public class MenuController {
    ...
    @ApiImplicitParam(paramType = "path", name = "id", value = "主键ID", required = true, dataType = "")
    @PutMapping(value="/{id}")
    public Result update(@RequestBody @ApiParam(name = "Menu对象",value = "传入JSON数据",required = false) Menu menu,@PathVariable  id){
        //设置主键值
        menu.set(id);
    ...
    @ApiImplicitParam(paramType = "path", name = "id", value = "主键ID", required = true, dataType = "")
    @GetMapping("/{id}")
    public Result<Menu> findById(@PathVariable  id){
