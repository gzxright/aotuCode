...
public class StringUtils {
    ...
    public static String firstUpper(String str){
        return com.mysql.cj.util.StringUtils.isNullOrEmpty(str)?"":str.substring(0,1).toUpperCase()+str.substring(1);
    }
    ...
    public static String firstLower(String str){
        return com.mysql.cj.util.StringUtils.isNullOrEmpty(str)?"":str.substring(0,1).toLowerCase()+str.substring(1);
    }
